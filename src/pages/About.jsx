    ...
    <div className="max-w-4xl mx-auto space-y-12 py-6 animate-in fade-in slide-in-from-bottom-6 duration-300">
      ...
      <div className="glass-card p-8 md:p-12 space-y-8">
        <div className="space-y-4">
          ...
          <p className="text-slate-400 leading-relaxed">
            At **91PDFConverter**, we believe document processing should be safe and local. By leveraging cutting-edge web technologies like WebAssembly, HTML5 canvas, and local worker sandboxes, we compile and encrypt files directly in the browser. Your files never touch a server, ensuring absolute privacy.
          </p>
        </div>
