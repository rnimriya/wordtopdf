  ...
  const megamenuColumns = [
    {
      ...
      links: [
        { name: 'Word to PDF', path: '/convert/word-to-pdf', iconText: 'DOC', iconBg: 'bg-blue-50 text-blue-600 border border-blue-100' },
        { name: 'Excel to PDF', path: '/convert/excel-to-pdf', iconText: 'XLS', iconBg: 'bg-emerald-50 text-emerald-600 border border-emerald-100' },
        { name: 'PPT to PDF', path: '/convert/ppt-to-pdf', iconText: 'PPT', iconBg: 'bg-orange-50 text-orange-600 border border-orange-100' },
        { name: 'JPG to PDF', path: '/convert/jpg-to-pdf', iconText: 'JPG', iconBg: 'bg-rose-50 text-rose-600 border border-rose-100' },
        { name: 'AutoCAD to PDF', path: '/convert/autocad-to-pdf', iconText: 'CAD', iconBg: 'bg-cyan-50 text-cyan-600 border border-cyan-100' },
        { name: 'OpenOffice to PDF', path: '/convert/openoffice-to-pdf', iconText: 'ODT', iconBg: 'bg-sky-50 text-sky-600 border border-sky-100' },
        { name: 'eBooks to PDF', path: '/convert/ebooks-to-pdf', iconText: 'PUB', iconBg: 'bg-violet-50 text-violet-600 border border-violet-100' },
        { name: 'iWork to PDF', path: '/convert/iwork-to-pdf', iconText: 'KEY', iconBg: 'bg-amber-50 text-amber-600 border border-amber-100' },
        { name: 'HTML to PDF', path: '/html-to-pdf', iconText: 'HTM', iconBg: 'bg-purple-50 text-purple-600 border border-purple-100' },
        { name: 'Text to PDF', path: '/convert/text-to-pdf', iconText: 'TXT', iconBg: 'bg-slate-150 text-slate-600 border border-slate-200' },
        { name: 'RTF to PDF', path: '/convert/rtf-to-pdf', iconText: 'RTF', iconBg: 'bg-indigo-50 text-indigo-600 border border-indigo-100' },
        { name: 'ODT to PDF', path: '/convert/odt-to-pdf', iconText: 'ODT', iconBg: 'bg-teal-50 text-teal-600 border border-teal-100' },
      ]
    },
    {
      ...
      links: [
        ...
        { name: 'PDF to PDF/A', path: '/convert/pdf-to-pdfa', iconText: 'PDF/A', iconBg: 'bg-slate-150 text-slate-700 border border-slate-200' },
          ...
          <div className="max-w-7xl mx-auto px-6 py-8 grid grid-cols-5 gap-6">
            {megamenuColumns.map((col) => (
              <div key={col.title} className="space-y-4">
                <h4 className="font-display font-extrabold text-slate-900 text-xs uppercase tracking-wider border-b border-slate-100 pb-2.5">
                  {col.title}
                </h4>
