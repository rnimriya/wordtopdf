...
function ToolLayout({
  ...
  const getFaqs = (titleStr) => {
    ...
    if (t.includes('merge')) {
      ...
      return [
        ...
        { q: 'Does 91PDFConverter add its own watermarks to my files?', a: 'No. Your compiled outputs remain entirely clean, professional, and free of any third-party branding.' }
      ];
    ...
    return [
      { q: `Is it safe to use this online tool to ${action}?`, a: `Yes, 91PDFConverter is 100% secure. All document processing takes place directly inside your web browser's local sandbox memory using client-side WebAssembly execution. Your private data is never sent over the network to any third-party server.` },
      { q: `Does 91PDFConverter upload my files to any server?`, a: `No, never. Unlike other online converters, 91PDFConverter operates on a zero-upload model. Your files remain entirely on your local machine, rendering in-memory buffer grids, which completely eliminates data leakage risk.` },
      ...
      { q: `Do I need to sign up or create an account to use this utility?`, a: `No sign-up or registry is required. All converters and PDF editors on 91PDFConverter are fully accessible, open, and free for all users with no daily caps or subscriptions.` },
      ...
      { q: `Can I use this tool on my smartphone or tablet?`, a: `Absolutely. 91PDFConverter is responsive and works smoothly across mobile Safari, Chrome, and desktop viewports, executing in-browser scripts on iOS, Android, macOS, and Windows.` },
  ...
  useEffect(() => {
    ...
    document.title = `Free ${title} Online | 100% Private 91PDFConverter`;
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Section 2: Why Choose 91PDFConverter Benefits Grid */}
      <section className="bg-white border border-slate-200/80 rounded-2xl p-6 md:p-8 space-y-6 max-w-5xl mx-auto shadow-sm">
        <div className="text-center space-y-3">
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 font-display">
            Why Choose 91PDFConverter for {title}?
          </h2>
          <p className="text-sm text-slate-600 max-w-2xl mx-auto leading-relaxed">
